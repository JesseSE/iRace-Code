...
<link href="<%=request.getContextPath()%>/public/css/style.css"
	rel="stylesheet" type="text/css" media="all" />
<link href="<%=request.getContextPath()%>/public/css/form.css"
	rel="stylesheet" type="text/css" media="all" />
<link href='<%=request.getContextPath()%>/public/css/family.css'
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/public/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/public/js/locales/bootstrap-datetimepicker.fr.js"></script>
...
<link href="<%=request.getContextPath()%>/public/css/megamenu.css"
	rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript"
...
<script
	src="<%=request.getContextPath()%>/public/js/css3-mediaqueries.js"></script>
...
<script type="text/javascript">
					...
					.ajax({
						...
						success : function(res) {
							if (res.code == 200) {
								...
								html += "<td>" + desc + "</td>";
								html += "<td><a class='operate' href='javascript:delProperty("
										+ res.msg + ")'>删除</a>";
								html += "</tr>";
	...
	function delProperty(id) {
		if (confirm("你真的要删除属性"
				+ $("#property-data tr.item" + id + " td.name").html() + "吗?")) {
			$.ajax({
...
<script type="text/javascript">
					...
					.ajax({
						...
						success : function(res) {
							if (res.code == 200) {
								...
								html += "<td>"
										+ $(
												"#priceGroupAdd option[value="
														+ groupId + "]").html()
										+ "</td>";
								html += "<td class='name'>" + name + "</td>";
								html += "<td>" + desc + "</td>";
								html += "<td><a class='operate' href='javascript:delReward("
										+ res.msg + ")'>删除</a>";
								html += "</tr>";
	...
	function delReward(id) {
		if (confirm("你真的要删除“"
				+ $("#reward-data tr.item" + id + " td:nth-child(2)").html()
				+ "”的“"
				+ $("#reward-data tr.item" + id + " td:nth-child(3)").html()
				+ "”吗?")) {
			$.ajax({
...
<script type="text/javascript">
					...
					.ajax({
						...
						success : function(res) {
							if (res.code == 200) {
								...
								html += "<td>" + endTime + "</td>";
								html += "<td>" + desc + "</td>";
								html += "<td><a class='operate' href='javascript:delStage("
										+ res.msg + ")'>删除</a>";
								html += "</tr>";
	...
	function delStage(id) {
		if (confirm("你真的要删除“"
				+ $("#stage-data tr.item" + id + " td:nth-child(2)").html()
				+ "”的“"
				+ $("#stage-data tr.item" + id + " td:nth-child(3)").html()
				+ "”吗?")) {
			$.ajax({
...
<script type="text/javascript">
					...
					.ajax({
						...
						success : function(res) {
							if (res.code == 200) {
								...
								html += "<td class='name'>" + name + "</td>";
								html += "<td>" + desc + "</td>";
								html += "<td><a class='operate' href='javascript:delGroup("
										+ res.msg + ")'>删除</a></td>";
								html += "</tr>";
	...
	function delGroup(id) {
		if (confirm("你真的要删除组别"
				+ $("#group-data tr.item" + id + " td.name").html() + "吗?")) {
			$.ajax({
...
<body>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav" style="font-family: 微软雅黑;">
							<li><a href="racemanage_detail.html"
								style="color: #FFF; background-color: #4cb1ca;">基本信息管理<span
									class="sr-only">(current)</span></a></li>
							<li><a
								href="<%=request.getContextPath() %>/race/RaceManageStage?raceID=${raceID}">比赛审核</a></li>
					...
					<div class="top-box" name="my_race">
						<ul class="nav nav-tabs" style="font-family: 微软雅黑;">
							<li role="presentation" class="active"><a href="##"
								id="tab1" onclick="detailTab(1);"
								style="background-color: #DFF0D8;"><h4>比赛描述</h4></a></li>
							<li role="presentation" class="active"><a href="##"
								id="tab2" onclick="detailTab(2);"><h4>报名要求</h4></a></li>
							<li role="presentation" class="active"><a href="##"
								id="tab3" onclick="detailTab(3);"><h4>组别设置</h4></a></li>
							<li role="presentation" class="active"><a href="##"
								id="tab4" onclick="detailTab(4);"><h4>阶段设置</h4></a></li>
							<li role="presentation" class="active"><a href="##"
								id="tab5" onclick="detailTab(5);"><h4>奖项设置</h4></a></li>
							<li
								style="position: relative; float: right; margin-top: 10px; margin-left: 0px;"><button
									style="font-family: 微软雅黑; border: 0px; padding: 10px; color: #FFF; background-color: #4cb1ca; margin-right: 17px; margin-top: -10px">
									<a style="color: #FFF" href="javascript:publishRace();">点击发布比赛</a>
								</button></li>
						</ul>
						<!--                比赛描述-->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<h4 class="title" style="font-weight: bold;">
										...
										<div style="float: right;">
											<img style="width: 14px; height: 14px;"
												src="<%=request.getContextPath()%>/public/images/edit-icon.jpg"></img>
											<a onclick="changePic();" style="font-size: 0.7em;">修改图片</a>
										</div>
									</h4>
									<div
										style="float: left; width: 407px;; height: 400px; margin-left: 25%; margin-top: 20px;">
										...
										<div class="headImg" id="headImg">
											...
											<div class="picBtn" id="chooseBtn" style="display: none;">
												...
												<form id="avatar-form"
													action="<%=request.getContextPath()%>/upload/img"
													method="POST" enctype="multipart/form-data">
													<input name="uploadFile" id="upimg" type="file"
														onchange="previewImage(this);" value="更换头像"
														style="display: none;" />
												</form>
											</div>
											<div class="picBtn" id="picSubmit"
												style="display: none; margin-left: 192px;">
												<a onclick="javascript:$('#avatar-form').submit();">完成更换</a>
											</div>
										</div>
									</div>

									<h4 class="title" style="font-weight: bold; margin-top: 450px;">
										文字描述管理
										<div style="float: right;">
											<img style="width: 14px; height: 14px;"
												src="<%=request.getContextPath()%>/public/images/edit-icon.jpg"></img>
									...
									<form class="form-horizontal" action="" method="post"
										id="joinus" name="joinus"
										style="width: 100%; margin-top: 0px; margin-left: 10%;">
										<div id="userInfo" style="margin-top: 20px; margin-left: 0px;">
											<table class="formTable"
												...
												<tr
													...
													<td style="padding: 10px 10px; width: 90px;">比赛名称</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preName">${race.getName() }</font></td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">比赛级别</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preGrade">${race.getGrade() }</font></td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">开始时间</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preStartTime">${race.getStrTime(race.getStartTime()) }</font>
													</td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">结束时间</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preEndTime">${race.getStrTime(race.getEndTime()) }</font>
													</td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">限制人数</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preNumRest">${race.getNumRest() }</font></td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">描述</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preContent">${race.getContent() }</font></td>
												</tr>
												<tr
													style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
													<td style="padding: 10px 10px;">类型</td>
													<td style="padding: 10px 10px;"><font name="showInfo"
														id="preBigType">${race.getTypeRaceEntity().getBigTypeEntity().getName() }</font>
										...
										<div id="changePwd"
											style="display: none; margin-top: 50px; margin-left: -100px; font-family: 微软雅黑;">
											<div class="form-group">
												<label for="name" class="col-sm-2 control-label">比赛名称</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" id="name"
														name="name" placeholder="Name" onblur=""
														value="${race.getName() }">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" id="grade"
														name="grade" placeholder="Grade" onblur=""
														value="${race.getGrade() }">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control"
														value="${race.getStrTime(race.getStartTime()) }"
														id="raceStartTime">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control"
														value="${race.getStrTime(race.getEndTime()) }"
														id="raceEndTime">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control" id="limitNum"
														min="1" max="50" step="1" name="limitNum"
														placeholder="Limit Number" value="${race.getNumRest() }">
												</div>
											</div>
											<div class="form-group">
												<label for="type" class="col-sm-2 control-label"
													style="margin-top: -5px;">类型</label>
												<div class="col-sm-4">
													<select class="" name="" id="bigType">
														<c:forEach var="bt" items="${bigTypeList }">
															<option value="${bt.getId() }">${bt.getName() }</option>
														</c:forEach>
													</select> -> <select class="" name="" id="smallType">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<textarea type="text" class="form-control" id="describe"
														...
														describe" placeholder="Describe" onblur="">${race.getContent() }</textarea>
												</div>
											</div>
											<div class="form-group">
													...
													<table class="table"
															...
															<c:forEach var="reward" items="${rewardList }">
																...
																<c:forEach var="r" items="${reward.get('rlist') }">
																	<tr class="item${r.getId() }">
																		...
																		<td>${r.getContent() }</td>
																		<td><a class="operate"
																			href="javascript:delReward(${r.getId() })">删除</a></td>
																	</tr>
																</c:forEach>
														...
														<div name="addPrice">
															<tr id="addPrice">
																...
																<td><a class="operate"
																	href="javascript:addPriceIn();"
																	style="margin-right: 0%;">添加</a>
															</tr>
														</div>
													</table>
												</div>
															...
															<c:forEach var="exStage" items="${stageList }">
																<c:forEach var="s" items="${exStage.get('slist') }">
																	<tr class="item${s.getId() }">
																		...
																		<td>${s.getContent() }</td>
																		<td><a class="operate"
																			href="javascript:delStage(${s.getId() })">删除</a></td>
																	</tr>
																</c:forEach>
															</c:forEach>
															<!--/table-->
													...
													<table class="table"
														...
														<tbody id="property-data">
															<c:forEach var="p" items="${propertyList }" varStatus="i">
																<tr class="item${p.getId() }">
																	...
																	<td>${p.getRequires() }</td>
																	<td><a class="operate"
																		href="javascript:delProperty(${p.getId() })">删除</a>
																</tr>
															</c:forEach>
														...
														<div name="addProperty">
															<tr id="addProperty">
																...
																<td><a class="operate" onclick="addPropIn();"
																	style="margin-right: 0%;">添加</a>
															</tr>
														</div>
													</table>
													...
													<table class="table"
														...
														<tbody id="group-data">
															<c:forEach var="g" items="${groupList }" varStatus="i">
																<tr class="item${g.getId() }">
																	...
																	<td>${g.getRequires() }</td>
																	<td><a class="operate"
																		href="javascript:delGroup(${g.getId() })">删除</a></td>
																</tr>
															</c:forEach>
														...
														<div name="addGroup">
															<tr id="addGroup">
																...
																<td><a class="operate" onclick="addGroupIn();"
																	style="margin-right: 0%;">添加</a>
															</tr>
														</div>
													</table>
	...
	<script
		src="<%=request.getContextPath()%>/public/js/jquery.form.min.js"
...
function publishRace() {
	if(confirm("你确定要发布比赛？")) {
		...
		$.ajax({
			url: $("#appName").val()+"/organizer/publishRace/" + $("#raceId").val(),
			type: "POST",
			dataType: "JSON",
			success: function(res) {
				if (res.code == 200) {
