...
<body>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav" style="font-family: 微软雅黑;">
							<li><a
								href="<%=request.getContextPath()%>/organizer/orgcenter">比赛管理</a></li>
							<li><a
								href="<%=request.getContextPath()%>/organizer/orginfo"
								style="color: #FFF; background-color: #4cb1ca;">机构信息管理<span
									class="sr-only">(current)</span></a></li>
							<li><a
								href="<%=request.getContextPath()%>/organizer/orgaccount">机构账号管理</a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
				</div>
	...
	<div class="main" style="margin-top: -25px;">
		<div class="wrap">
				...
				<div class="cont span_2_of_3">
					...
					<div class="register_account">
						<div class="wrap">
							...
							<div id="showInfo"
								style="margin-top: 48px; margin-bottom: 45px; margin-left: 70px;">
								<table class="formTable"
									style="width: 300px; text-align: justify;">
									<tr
										style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
										<td style="padding: 10px 10px;">机构名称</td>
										<td style="padding: 10px 10px;"><font name="showInfo">${ organizer.getName() }</font>
										</td>
									</tr>
									<tr
										style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
										<td style="padding: 10px 10px;">电子邮件</td>
										<td style="padding: 10px 10px;"><font name="showInfo">${ organizer.getEmail() }</font>
										</td>
									</tr>
									<tr
										style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
										<td style="padding: 10px 10px;">电话</td>
										<td style="padding: 10px 10px;"><font name="showInfo">${ organizer.getTel() }</font>
										</td>
									</tr>
									<tr
										style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
										<td style="padding: 10px 10px;">城市</td>
										<td style="padding: 10px 10px;"><font name="showInfo">${ organizer.getCity() }</font>
										</td>
									</tr>
									<tr
										style="margin-bottom: 10px; color: #000; font-family: 微软雅黑; border: solid 2px #4cb1ca">
										<td style="padding: 10px 10px;">Comment</td>
										<td style="padding: 10px 10px;"><font name="showInfo">${ organizer.getComment() }</font>
										</td>
									</tr>
								</table>
							...
							<div id="modifyInfo"
								style="display: none; margin-top: 5px; margin-bottom: 18px;">
								<form class="form-horizontal" id="joinus" name="joinus">
									<div class="form-group">
										<label for="organizername" class="col-sm-2 control-label">机构名称</label>
										<div class="col-sm-4">
											<input type="input" class="form-control" id="organizername"
												name="organizername" placeholder="${ organizer.getName() }"
												readOnly="true"></input>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="input" class="form-control" id="email"
												name="email" placeholder="${ organizer.getEmail() }"
												onblur="check_email()"></input>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="tel" class="form-control" id="phone"
												name="phone" placeholder="${ organizer.getTel() }"></input>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="input" class="form-control" id="city"
												name="city" placeholder="${ organizer.getCity() }"></input>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="input" class="form-control" id="comment"
												name="comment" placeholder="Commet"></input>
										</div>
									</div>
			...
			<!-- 取得用户id -->
			<input id="orIDHtml" type="hidden"
				value="<%=session.getAttribute("oid")%>">
					...
					$("#submit-btn").click(function() {
						$.ajax({
							...
							success : function(res) {
								alert("修改成功！!");
								console.log(res);
								location.href = $("#appName").val()+ "/organizer/orginfo";
							},
							error : function(res) {
								console.log(res);
								alert('提交失败，请重新操作！');
