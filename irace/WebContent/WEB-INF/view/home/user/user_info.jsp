		...
		<div class="section group">            
		  <div class="cont span_2_of_3">
			...
			<div class="register_account">
          	<div class="wrap">
    	      <h4 class="title" style="font-weight:bold;">个人信息管理 
			  ...
			  <table class="formTable" style="width:300px;text-align:justify;">
				...
				<tr style="margin-bottom:10px;color:#000;font-family:微软雅黑;border:solid 2px #4cb1ca">
					...
					<td style="padding:10px 10px;">
					  <font name="showInfo">741753181</font>
					</td>
				</tr>
				<tr style="margin-bottom:10px;color:#000;font-family:微软雅黑;border:solid 2px #4cb1ca">
					<td style="padding:10px 10px;">
					...
					<td style="padding:10px 10px;">
					  <font name="showInfo">北京交通大学</font>
					</td>
				</tr>
				<tr style="margin-bottom:10px;color:#000;font-family:微软雅黑;border:solid 2px #4cb1ca">
					<td style="padding:10px 10px;">
			  ...
			  <div id="modifyInfo" style="display:none;margin-top:40px;">
		    	<form class="form-horizontal" action="" method="post" id="joinus" name="joinus">
				  <div class="form-group">
				    <label for="nickname" class="col-sm-2 control-label">昵称</label>
				    <div class="col-sm-4">
				      <input type="input" class="form-control" id="nickname" name="nickname" placeholder="Nickname"></input>
				    </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-4">
				      <input type="input" class="form-control" id="email" name="email" placeholder="Email" onblur="check_email()"></input>
					</div>
				  ...
				  <div class="form-group">
				  	...
				  	<div class="col-sm-4" id="sexRadio" >
					    <label class="radio-inline">
						  <input hidden="" type="radio" name="sexRadioOptions" id="maleRadio" value="0"> 男</input>
						</label>
						<label class="radio-inline">
						  <input hidden="" type="radio" name="sexRadioOptions" id="femaleRadio" value="1"> 女</input>
						</label>
					</div>
				  </div>
				  <div class="form-group">
				    ...
				    <div class="col-sm-4">
				      <input type="input" class="form-control" id="qq" name="qq" placeholder="QQ"></input>
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="school" class="col-sm-2 control-label">学校</label>
				    <div class="col-sm-4">
				      <input type="input" class="form-control" id="school" name="school" placeholder="School"></input>
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="major" class="col-sm-2 control-label">专业</label>
				    <div class="col-sm-4">
				      <input type="input" class="form-control" id="major" name="major" placeholder="Major"></input>
				    </div>
				  </div>
