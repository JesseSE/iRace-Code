...
<link
	href="<%=request.getContextPath()%>/public/bootstrap-3.3.4-dist/css/bootstrap.min.css"
	rel='stylesheet' type='text/css'>
<link
	href="<%=request.getContextPath()%>/public/bootstrap-3.3.4-dist/css/bootstrap-theme.min.css"
	rel='stylesheet' type='text/css'>
...
<script
	src="<%=request.getContextPath()%>/public/js/jquery-1.11.2.min.js"
	type="text/javascript"></script>
<script
	src="<%=request.getContextPath()%>/public/bootstrap-3.3.4-dist/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/public/js/megamenu.js"
	type="text/javascript"></script>
<script
